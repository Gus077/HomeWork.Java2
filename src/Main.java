 ...
 */
    public static void main(String[] args) {
        ...
        List<String> s = new ArrayList<>(20);
            s.addAll(Arrays.asList("apple","mango","banana","cherry","orange","avocado","apple","cherry",
            "pear","pineapple","orange","lemon","kiwi","melon","watermelon","lemon",
            "orange","mango","cherry","lime"));
        ...
        for (int i = 0; i < s.size(); i++) {
            m.put(s.get(i), m.getOrDefault(s.get(i),0) + 1);
        }
        ...
        pb.add("Gusakov", "89276534705");
        pb.add("Gusakov", "89272046527");

        System.out.println(pb.get("Gusakov"));
    }
}
